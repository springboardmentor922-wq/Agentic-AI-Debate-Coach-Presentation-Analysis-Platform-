...
export const EDUCATOR_DATA = {
  ...
  avgClassScore: 72.4,
  myClasses: [
    { name: 'AP Ethics & Social Media Policy Debate', shortName: 'AP Social Media', learners: 32, avgScore: 84.8, trend: '+7.2' },
    { name: 'Lincoln-Douglas: Universal Basic Income & Welfare', shortName: 'LD Basic Income', learners: 28, avgScore: 72.4, trend: '+4.6' },
    { name: 'Parliamentary: Climate Policy & Clean Energy Subsidies', shortName: 'Parl Climate', learners: 24, avgScore: 89.1, trend: '+6.1' },
    { name: 'Oxford Debate: AI Automation & Labor Market Shifts', shortName: 'Oxford AI Labor', learners: 22, avgScore: 68.5, trend: '+3.8' },
    { name: 'Public Forum: High School Curricula & Mandatory PE', shortName: 'PF Curricula PE', learners: 22, avgScore: 85.3, trend: '+9.3' },
  ],
  classDistribution: [
