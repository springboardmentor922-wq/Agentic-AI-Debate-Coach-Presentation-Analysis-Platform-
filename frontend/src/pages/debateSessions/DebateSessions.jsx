            ...
            <div className="debate-sessions-page">
                <div className="sessions-hero-card">
                    <div className="sessions-hero-copy">
                        <span className="page-badge">Session Planner</span>
                        <h1>Find the right debate session for your next challenge</h1>
                        <p>Review available sessions, compare formats, and join the format that best matches your current skill level.</p>
                    </div>
                ...
                <div className="sessions-filter-shell">
                    <SessionFilters
