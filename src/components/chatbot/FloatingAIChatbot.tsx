...
export const FloatingAIChatbot: React.FC<FloatingAIChatbotProps> = ({ currentTab }) => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'msg_0',
      sender: 'ai',
      text: `Hello Alex! I am your AI Debate Orchestrator. Currently synced with **${currentContext.title}**. How can I assist you with argument structure or speech quality right now?`,
