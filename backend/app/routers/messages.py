...
async def unread_count(current_user: dict = Depends(get_current_user)):
    ...
    across all conversation partners. Mirrors notifications' /unread-count
    shape (`{"unread_count": <int>}`) so the frontend can poll it the same
    way it polls notifications."""
