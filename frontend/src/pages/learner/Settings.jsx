  ...
  return (
    <div className="mx-auto max-w-2xl page-fade flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-5">
        {/* Account */}
        <Card className="border border-black/10 bg-white shadow-card dark:border-brand-500/20 dark:bg-gradient-to-br dark:from-brand-900/20 dark:to-accent-900/20">
          <p className="mb-4 text-xs font-semibold uppercase tracking-widest text-brand-600 dark:text-brand-300">
            Account
          </p>

          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-brand-500 to-accent-500 text-white shadow-glass">
              <UserCircle2 size={28} />
            </div>
          ...
          <Button
            variant="secondary"
            size="sm"
            className="mt-5 border border-brand-500/30 hover:bg-brand-500/10"
        ...
        <Card className="border border-black/10 bg-white shadow-card dark:border-brand-500/20 dark:bg-gradient-to-br dark:from-brand-900/20 dark:to-accent-900/20">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button
              variant="secondary"
              size="sm"
              className="border border-brand-500/30 hover:bg-brand-500/10"
        ...
        {/* Logout */}
        <Card className="border border-red-200 bg-white shadow-card dark:border-red-500/20 dark:bg-gradient-to-br dark:from-red-900/10 dark:to-brand-900/10">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-ink-900 dark:text-white">
                Log out
